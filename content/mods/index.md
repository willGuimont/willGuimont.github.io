...
To enable these mods, you need to paste provided Sass to [appropriate file](@/_index.md), e.g `sass/mods.scss` under your website, then enable it in `config.toml`:
